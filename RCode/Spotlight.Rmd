...
#Subset table
var_select <-c("Codes","Category", "Description", "Mean_Value","Year_of_Publication", "Rank", "Rank_out_of","Class_levels", "Organisation", "URL")
#Grouping names
...
#--------------------MERGE basic risk and country stats df----------
all<-plyr::rbind.fill(country_all,adm_country) %>%
  mutate(Description = as.character(paste0("The ", Index_name," for ", country_full," is estimated to be ",
                                           Value, " (units), which is considered as ", `Comparative Value`," risk as compared to ",
